  ...
  return (
    <>
        <div className="mb-3 flex justify-end">
            <button
             onClick={open}
            className='px-3 py-2 border-none outline-none text-white rounded-sm bg-blue-700'>Add Job</button>
        </div>
                ...
                <Form className="py-4">
                  ...
                  <div className="mb-3">
                    <label htmlFor="skills">Skills</label>
                              ...
                              <ul className='grid grid-cols-5 gap-y-2 gap-x-2 cursor-pointer'>
                                {
                                  skills.map((skill, index) =>(
                                        ...
                                        className={`'py-2 w-full border border-blue-500 px-3 my-2'
                                        ${values.skills.includes(skill)?'bg-blue-500 rounded-sm  text-white' : 'border-blue-500 text-black'}
                                        `}>{skill}</li>
                                  ))
                                }
                              </ul>
                  ...
                  <div className="mb-3">
                    <button type="submit" className="w-full py-2 border-none outline-none text-white rounded-sm bg-blue-700">Post Job</button>
                  </div>
                </Form>
                )}
              </Formik>
